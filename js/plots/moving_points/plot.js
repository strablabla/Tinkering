...
make_plot.prototype.update = function() {
  ...
  circle.enter().append("circle")
      .attr("r", 3.0)
      .on("mousedown", function(d) { selected = dragged = d; self.update(); })
...
//     function dragged(d) {
//       d3.select(this).attr("cx", function(){d.x = d3.event.x; return d.x})
//                      .attr("cy", function(){d.y = d3.event.y; return d.y});
//     }
...
function make_plot.prototype.mousedown() {
  this.dataset.push(selected = dragged = d3.mouse(this.vis.node()));
  update();
}
